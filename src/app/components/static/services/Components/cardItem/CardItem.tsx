...
export const CardItem = ({ title, text, image }: CardItemProps) => (
  <article className="w-fit sm:max-w-[520px] md:max-w-[800px] h-fit mx-auto flexCol md:flexRow lg:flexCol md:gap-8 overflow-hidden">
    <div className="relative rounded-3xl overflow-hidden w-full md:max-w-[350px] z-20">
      <Image
        src={image}
    ...
    <div className="relative w-full h-fit md:h-full z-10 mt-3 md:m-0 flex flex-col justify-between">
      ...
      <div className="w-full h-[250px] md:max-w-[350px] lg:mt-4 flex flex-col justify-between">
