...
export const About = () => {
  return (
    <div className="w-full h-full flexCol lg:flexRow gap-20 bg-darkBlack p-8 lg:p-16">
      <div className="relative hidden lg:block w-[380px] pt-20 pb-20">
        <Image
      ...
      <div className="md:max-w-[650px] lg:max-w-[600px]  text-white">
        ...
        <h2 className="text-center text-xl lg:text-left lg:text-2xl mb-8 text-mvGreen ">
          High Quality Local Electricians
        </h2>
        <p className="text-justify lg:text-left text-md mb-4 text-[17px]">
        ...
        <p className="text-justify lg:text-left mb-4 text-[17px]">
        ...
        <p className="text-justify lg:text-left text-[17px]">
